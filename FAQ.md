...
Make sure you followed through the [deployment instructions](#deployment) in the previous section. You should have set the deployment branch to `gkf-pages`. (Related issue: [1438](https://github.com/alshedivat/al-folio/issues/1438).)
